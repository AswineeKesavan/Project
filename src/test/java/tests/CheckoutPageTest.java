...
public class CheckoutPageTest extends baseTest{
    ...
    public void testCheckoutPage(){
        ...
        checkoutPage.setFirstName("Aswinee");
        checkoutPage.setLastName("Kesavan");
        ...
        checkoutPage.setEmailAddress("aswineek7@gmail.com");
        checkoutPage.setMobileNumber("9876543290s");
